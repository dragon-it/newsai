...
### 2026-08-28 꺾은선 차트 '일일 위험 가속도' 파동 시각화 전환 및 누적 지수 0.1pt 스케일링 적용

- **검토 대상**: `dashboard/src/App.jsx`, `src/formatters/generateJson.js`, `data.json`, `docs/plan.md`, `docs/review.md`
- **구현 내용**:
